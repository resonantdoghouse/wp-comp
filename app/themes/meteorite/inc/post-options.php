...
class Meteorite_Post_Metabox {
	...
	public function save( $post_id ) {
		...
		$meteorite_post_image_header_title 		= isset( $_POST['meteorite_post_image_header_title'] ) ? sanitize_text_field($_POST['meteorite_post_image_header_title']) : false;
		...
		$meteorite_post_image_header_text 		= isset( $_POST['meteorite_post_image_header_text'] ) ? sanitize_text_field($_POST['meteorite_post_image_header_text']) : false;
